...
var (
	...
	projectImage = "quay.io/validator-labs/validator-plugin-vsphere:latest"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting validator-plugin-vsphere integration test suite\n")
