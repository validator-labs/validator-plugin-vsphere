...
import (
	...
	"github.com/spectrocloud-labs/validator-plugin-vsphere/tests/integration/common"
	"github.com/spectrocloud-labs/validator-plugin-vsphere/tests/integration/tags"
